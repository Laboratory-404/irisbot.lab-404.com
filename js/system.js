...
(function(global) {
	...
	var dumpSystem = function() {
		var dump = [{
			...
			Feature: 'SYSTEM_FEATURE_WEBSPEECH_RECOGNITION',
			Value: SYSTEM_FEATURE_WEBSPEECH_RECOGNITION ? 'TRUE' : 'FALSE'
		} , {
			Feature: 'SYSTEM_FEATURE_WEBSPEECH_SYNTHESIS',
			Value: SYSTEM_FEATURE_WEBSPEECH_SYNTHESIS ? 'TRUE' : 'FALSE'
		} , {
